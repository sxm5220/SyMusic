...
public class LTLayout: NSObject {
    ...
    @objc public var bottomLineColor: UIColor? = .orange
    
    /* 整个滑块的高，pageTitleView的高 */
    @objc public var sliderHeight: CGFloat = 50.0
    
    /* 单个滑块的宽度, 一旦设置，将不再自动计算宽度，而是固定为你传递的值 */
    @objc public var sliderWidth: CGFloat = 40.0//glt_sliderDefaultWidth
    ...
    /* pageView底部线的颜色 */
    @objc public var pageBottomLineColor: UIColor? = .clear//UIColor(r: 230, g: 230, b: 230)
