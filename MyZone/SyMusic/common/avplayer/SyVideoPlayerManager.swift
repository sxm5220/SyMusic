...
protocol SyVideoPlayerManagerDelegate: AnyObject {
...
extension SyVideoPlayerManagerDelegate {
...
class SyVideoPlayerManager: NSObject, SyVideoPlayerShowViewDelegate {
    // MARK:- 属性
    public var playerView: SyVideoPlayerShowView!
    ...
    public weak var delegate: SyVideoPlayerManagerDelegate?
    ...
    init(playerFrame: CGRect, contentView: UIView) {
        ...
        playerView = SyVideoPlayerShowView(frame: playerFrame, contentView: contentView)
...
extension SyVideoPlayerManager {// MARK: 外部调用方法
...
extension SyVideoPlayerManager {
