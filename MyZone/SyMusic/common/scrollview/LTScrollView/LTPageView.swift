...
extension LTPageView {
    private func setupTitleView() -> LTPageTitleView {
        let pageTitleView = LTPageTitleView(frame: CGRect(x: 0, y: 0, width: self.bounds.width, height: self.layout.sliderHeight), titles: titles, atIndex: -1, isNotice: false, layout: layout)
